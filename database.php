<?php
session_start();
$con=mysqli_connect("localhost","root","123456","book exchange");
...
$mail->Username = 'booking.BikeAndRoll@gmail.com';                 // SMTP username
$mail->Password = 'bike&roll';                           // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->setFrom('booking.BikeAndRoll@gmail.com', 'Bike&Roll:Style Over Speed');
$mail->addAddress($email); 
$mail->addReplyTo('booking.BikeAndRoll@gmail.com', 'Bike&Roll:Style Over Speed');

...
<div class="container-fluid h-100">
    <div class="row h-100">
        <div class="col-lg-2 bg-dark position-fixed" id="sidebar" style="height: 100%" >
            <table class="table table-borderless table-dark">
              <thead><th>Book Exchange</th></thead>
         ...
         <main class="col-lg offset-md-2">
          ...
          if($rte[0]!=0)
          {?>
         	<div  class="row" style="background-color: #e3e3e3;height: 50px;">
        <pre><h1>                Explore your Books!!!!</h1></pre>
      </div>
      <div class="row" style="background-color: rgba(50, 115, 220, 0.3);margin-top: 20px">
    <?php }?>
      <?php 
 ...
 <?php } ?>
  <div class="col-lg-12" style="background-color: #e3e3e3;height: 50px;text-align: center;">
